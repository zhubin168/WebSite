...
namespace Dafy.OnlineTran.Entity.Models
{
    ...
    public partial class Order : Entity<Order>
    {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            // 货币保留6位小数
            if (Dirtys[__.prodcutPrice]) prodcutPrice = Math.Round(prodcutPrice, 6);
        ...
        //    entity.prodcutPrice = 0;
        //    entity.clientUid = 0;
        //    entity.clientName = "abc";
        //    entity.clientPhone = "abc";
        //    entity.total = 0;
        //    entity.status = 0;
        ...
        #region 扩展查询﻿
        /// <summary>根据预约号查找</summary>
        /// <param name="__oid">预约号</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Order FindByoid(Int64 __oid)
        {
            if (Meta.Count >= 1000)
                return Find(_.oid, __oid);
            else // 实体缓存
                return Meta.Cache.Entities.Find(_.oid, __oid);
            // 单对象缓存
            //return Meta.SingleCache[__oid];
        }
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Order> FindAllByproductId(Int64 productid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Order> FindAllByproductName(String productname)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Order> FindAllByproductType(String producttype)
        {
            if (Meta.Count >= 1000)
