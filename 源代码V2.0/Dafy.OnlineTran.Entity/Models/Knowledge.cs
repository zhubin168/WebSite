...
namespace Dafy.OnlineTran.Entity.Models
{
    ...
    public partial class Knowledge : IKnowledge
    {
        ...
        [Description("小知识分享图片")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(3, "shareUrl", "小知识分享图片", null, "varchar(50)", 0, 0, false)]
        ...
        [Description("")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(5, "listUrl", "", null, "varchar(50)", 0, 0, false)]
        ...
        [Description("正文链接")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(6, "contentUrl", "正文链接", null, "varchar(50)", 0, 0, false)]
