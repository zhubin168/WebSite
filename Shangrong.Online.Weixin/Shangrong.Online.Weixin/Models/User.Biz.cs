...
namespace Dafy.OnlineTran.Entity.Models
{
    ...
    public partial class User : Entity<User>
    {
        ...
        /// <summary>该用户表所对应的公司部门职位表</summary>
        [XmlIgnore]
        ...
        public Role Role
        {
            get
            {
                ...
                {
                    _Role = Role.FindByroleId(roleId);
                    Dirtys["Role"] = true;
                }
                return _Role;
            }
        ...
        public static User FindByuid(Int64 __uid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<User> FindAllBycompanyId(Int64 companyid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <summary>根据所属角色ID查找</summary>
        /// <param name="roleid">所属角色ID</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<User> FindAllByroleId(Int64 roleid)
        {
            if (Meta.Count >= 1000)
