...
namespace Dafy.OnlineTran.Entity.Models
{
    ...
    public partial class Company : Entity<Company>
    {
		...
		/// <summary>该公司部门职位表所拥有的产品表集合</summary>
		[XmlIgnore]
		public EntityList<Product> Products
		{
			get
			{
                ...
                {
					_Products = Product.FindAllBycompanyId(Id);
		...
		/// <summary>该公司部门职位表所拥有的用户表集合</summary>
		[XmlIgnore]
		public EntityList<User> Users
		{
			get
			{
                ...
                {
					_Users = User.FindAllBycompanyId(Id);
					Dirtys["Users"] = true;
				}
				return _Users;
			}
        ...
        public static Company FindById(Int64 id)
        {
            if (Meta.Count >= 1000)
                return Find(_.Id, id);
            else // 实体缓存
        ...
        /// <summary>根据创建者名称查找</summary>
        /// <param name="companyname">创建者名称</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<Company> FindAllByCompanyName(String companyname)
        {
            if (Meta.Count >= 1000)
