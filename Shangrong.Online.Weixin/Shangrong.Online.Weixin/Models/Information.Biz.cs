...
{
    /// <summary>资讯</summary>
    public partial class Information : Entity<Information>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(Information).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(Information).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        #region 扩展查询﻿
        /// <summary>根据资讯ID查找</summary>
        /// <param name="__id">资讯ID</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Information FindByid(Int64 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Information> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
