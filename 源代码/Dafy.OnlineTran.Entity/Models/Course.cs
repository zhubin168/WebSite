...
namespace Dafy.OnlineTran.Entity.Models
{
    ...
    [BindTable("Course", Description = "课程管理", ConnName = "Lomark", DbType = DatabaseType.SqlServer)]
    public partial class Course : ICourse
    {
        ...
        [BindColumn(2, "Name", "创建者名称", null, "nvarchar(150)", 0, 0, true)]
        ...
        [Description("创建者名称")]
        [DataObjectField(false, false, false, 150)]
        [BindColumn(3, "Title", "创建者名称", null, "nvarchar(150)", 0, 0, true)]
        ...
        [BindColumn(4, "Conent", "创建者名称", null, "text", 0, 0, false)]
        public virtual String Conent
        {
            get { return _Conent; }
            set { if (OnPropertyChanging(__.Conent, value)) { _Conent = value; OnPropertyChanged(__.Conent); } }
        }

        private String _IsRecomand;
        /// <summary>创建者名称</summary>
        [DisplayName("创建者名称")]
        [Description("创建者名称")]
        [DataObjectField(false, false, true, 150)]
        [BindColumn(5, "IsRecomand", "创建者名称", null, "nvarchar(150)", 0, 0, true)]
        public virtual String IsRecomand
        {
            get { return _IsRecomand; }
            set { if (OnPropertyChanging(__.IsRecomand, value)) { _IsRecomand = value; OnPropertyChanged(__.IsRecomand); } }
        }
        ...
        [Description("创建者名称")]
        [DataObjectField(false, false, true, 150)]
        [BindColumn(6, "ImageUrl", "创建者名称", null, "nvarchar(150)", 0, 0, true)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.Conent : return _Conent;
                    case __.IsRecomand : return _IsRecomand;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.Conent : _Conent = Convert.ToString(value); break;
                    case __.IsRecomand : _IsRecomand = Convert.ToString(value); break;
        ...
        #region 字段名
        /// <summary>取得课程管理字段信息的快捷方式</summary>
        public partial class _
        {
            ...
            ///<summary>创建者名称</summary>
            public static readonly Field Conent = FindByName(__.Conent);

            ///<summary>创建者名称</summary>
            public static readonly Field IsRecomand = FindByName(__.IsRecomand);
        ...
        /// <summary>取得课程管理字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>主键ID(自增列)</summary>
            ...
            ///<summary>创建者名称</summary>
            public const String Conent = "Conent";

            ///<summary>创建者名称</summary>
            public const String IsRecomand = "IsRecomand";
    ...
    public partial interface ICourse
    {
        ...
        /// <summary>创建者名称</summary>
        String Conent { get; set; }

        /// <summary>创建者名称</summary>
        String IsRecomand { get; set; }
